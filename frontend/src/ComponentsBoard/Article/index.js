...
function Article() {
    ...
    console.log('article.writer :', article.writer);
    // console.log('article.writer :', article.writer.nickname);
    ...
    return (
        <div className="Article">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container">
                    <a class="navbar-brand" href="#!">게시판 id : {id} </a>
                    ...
                    <div class="col-lg-8">
                        ...
                        <article>
                            ...
                            <header class="mb-4">
                                ...
                                <div class="text-muted fst-italic mb-2">작성자 : {writer.nickname}</div>
                                {/* <!-- Post categories--> */}
